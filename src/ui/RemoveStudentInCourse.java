 ...
 * @author AEVN
 */
public class RemoveStudentInCourse extends javax.swing.JFrame {

    /**
     * Creates new form RemoveStudentInCourse
     */
    public RemoveStudentInCourse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveStudentInCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveStudentInCourse().setVisible(true);
            }
        });
    }
